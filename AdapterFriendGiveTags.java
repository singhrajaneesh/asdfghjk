...
/**
 * Created by ekant on 08/03/16.
 */
public class AdapterFriendGiveTags extends BaseAdapter
{
    private LayoutInflater inflater=null;
    private Activity activity;
    public Context con;
    private ArrayList<HashMap<String, String>> data;
    public AdapterFriendGiveTags(Activity a, ArrayList<HashMap<String, String>> d, Context context)
    {
        activity = a;
        data = d;
        con = context;
